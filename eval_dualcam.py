...
def processImage1():
    ...
    try:
        ...
        # )240, 640, 3)
        _, org_dual_img = cap.read()
        #print(org_dual_img.shape)
        #_, org_img2 = cap2.read()
        org_img2 = org_dual_img[:,0:320*4,:]
        org_img = org_dual_img[:,320*4:320*2*4,:]
        #org_img  = org_dual_img.crop(0,0, 240,320)
        #org_img2 = org_dual_img.crop(0,320, 240,640)
